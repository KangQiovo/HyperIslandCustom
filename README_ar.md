...
**✨ وحدة Xposed لتخصيص الجزيرة الخارقة في HyperOS 3 — نسخة المعاينة ✨**
...
2. 📥 تنزيل أحدث APK من [**Releases**](https://github.com/KangQiovo/HyperIslandCustom-Preview/releases)
3. 📲 تثبيت APK
...
| المنصة | الحساب | الرابط |
|--------|--------|--------|
| 🟢 **酷安 (CoolAPK)** | @KangQi_ovo | [الملف الشخصي](http://www.coolapk.com/u/21241695) |
