...
class ThemeManager(
    ...
    var monetEnabled by mutableStateOf(false)
        private set
    var glassBarAlpha by mutableFloatStateOf(0.4f)
        private set
    var glassSliderAlpha by mutableFloatStateOf(0.6f)
        private set
    ...
    suspend fun load() {
        ...
        // Migrate from old defaults (MD3) to new defaults (MIUIX + LIQUID_GLASS)
        ...
        glassBarAlpha = prefs[KEY_GLASS_BAR_ALPHA] ?: 0.4f
        glassSliderAlpha = prefs[KEY_GLASS_SLIDER_ALPHA] ?: 0.6f
